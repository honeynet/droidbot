...
Java.perform(function() {
    var cn = "android.app.Instrumentation";
    var target = Java.use(cn);
    if (target) {
        target.callActivityOnNewIntent.overloads[0].implementation = function(dest) {
        ...
        target.callActivityOnPostCreate.overloads[0].implementation = function(dest) {
            var myArray=new Array()
            myArray[0] = "INTERESTED"  //INTERESTED & SENSITIVE
        ...
        target.callActivityOnRestoreInstanceState.overloads[0].implementation = function(dest) {
            var myArray=new Array()
            myArray[0] = "INTERESTED"  //INTERESTED & SENSITIVE
        ...
        target.callActivityOnSaveInstanceState.overloads[0].implementation = function(dest) {
            var myArray=new Array()
            myArray[0] = "INTERESTED"  //INTERESTED & SENSITIVE
        ...
        target.callActivityOnStart.implementation = function(dest) {
            var myArray=new Array()
            myArray[0] = "INTERESTED"  //INTERESTED & SENSITIVE
        ...
        target.callActivityOnUserLeaving.implementation = function(dest) {
            var myArray=new Array()
            myArray[0] = "INTERESTED"  //INTERESTED & SENSITIVE
        ...
        target.onException.implementation = function(dest) {
            var myArray=new Array()
            myArray[0] = "INTERESTED"  //INTERESTED & SENSITIVE
